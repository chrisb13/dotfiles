...
rsync -havz ~/codescratch/cms_analysis/ z3457920@squall.ccrc.unsw.edu.au:/home/z3457920/hdrive/repos/cms_analysis/ --include="*/" --include="*.py" --include="*.m" --include="*.md" --include="*.txt" --include="*.log" --include="*.sh" --include="*.list"  --include="*.nml" --exclude="*"
